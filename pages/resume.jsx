    ...
    <>
      ...
      <div className='max-w-[940px] mx-auto p-2 pt-[120px]'>
        ...
        <div className='text-center py-4'>
          <h5 className=' uppercase text-center underline text-[18px] py-2'> Technical Skills</h5>
          <p className='py-2'>
        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            <li>
                ...
                navigating to a new page) and React Hooks (for state management flexibility and re-render predictability)
            </li>
            <li>
                Organized the backend logic with Express, orchestrating the receiving and routing of APIs to customized
                middleware resulting in a flexible backend with global and local error handlers
            </li>
            <li>
                Stored Redis expired key-value data in a NoSQL database for its quick lookup time and ease of use as documents
                using key-value pairs to achieve scalability and maintain large volumes of unstructured data types
            </li>
            <li>
                Created the application’s landing page by implementing Next.js for its intuitive page routing, quick and SEO-friendly
                static-site generation, and built-in API functionality
            </li>
            <li>
                Wrote tests using Jest and Supertest frameworks, following Test-Driven Development principles to minimize
                debugging time, ensuring a consistent bug free user experience
            </li>
            <li>
        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            <li>
                Implemented the frontend state management with Redux to manage a deeply interconnected application, leveraging
                a consistent state container as the single source of truth from frequent dispatches to state
            </li>
            <li>
                Designed and implemented the application UI leveraging Bootstrap to build responsive web displays, using
                customizable and reusable components
            </li>
            <li>
                Deployed and integrated a PostgreSQL database to build a structured organization of relational data that can be
                quickly accessed with a relational query language, being efficient with complex and large volumes of required data
            </li>
            <li>
                Ensured stability and robustness in the codebase by writing unit tests using Jest, simplifying the debugging process
            </li>
          </ul>
        </div>
        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            <li>
                Developed the frontend of the React application, incorporating React Router to navigate to multiple pages without
        ...
        <div className='py-6'>
          ...
          <ul className='list-disc list-outside px-7 py-1 leading-relaxed'>
            <li>
                Created a consumer facing frontend application using HTML, CSS, and JavaScript that produces a layered image file
                of dynamically rendered images based on user inputs resulting in quick client side scripting and versatile functionality
            </li>
          </ul>
        </div>
        <div className='py-6'>
        <p>
            ...
            <span className='px-2 font-bold'> B.A. </span> @ University of California, Riverside <span> | </span>
            <span className='px-2 font-bold'> Software Engineering </span> @ Codesmith
        </p>
        <p>
            <span className='uppercase font-bold'>  Community Engagement: </span> 
            <span className='px-2 italic'>"Cache is King, The Importance of Caching"</span> Public Talk | Single Sprout Speaker Series
        </p>
        <p>
